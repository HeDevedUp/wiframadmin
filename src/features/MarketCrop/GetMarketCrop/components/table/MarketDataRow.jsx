...
import AddMarketDataModal from "../modals/AddMarketData";

const UserRow = ({ marketdata }) => {
    const [isDeleteModalOpen, setDeleteModalOpen] = useState(false);
    const [isEditModalOpen, setEditModalOpen] = useState(false);
    const [isAddMarketDataModalOpen, setAddmarketDataModalOpen] = useState(false);
      ...
      {marketdata ?(
        ...
        <th>
            <CrudDropdown
                ...
                onAddMarketdataClick = {() => setAddmarketDataModalOpen(true)}
            />
            <AddMarketDataModal
            openNow={isAddMarketDataModalOpen}
           onClose={() => setAddmarketDataModalOpen(false)}
           >
            </AddMarketDataModal>
            <UserDeleteModal
